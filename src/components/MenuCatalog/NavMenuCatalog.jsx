		...
		<S.NavMenu>
		  <S.MenuList>
			...
			<S.LeftMenuItem>
			  ...
			  { theme.theme === "black" ?
				  <S.ChangeThemeImg onClick={toggleTheme} src="/img/change_theme(black).svg" alt="change_theme_black"/> :
				  <S.ChangeThemeImg onClick={toggleTheme} src="/img/change_theme(white).svg" alt="change_theme_white"/>
			  }
		  </S.MenuList>
		</S.NavMenu>
	)

...
function App() {
  return (
    ...
    //           <img class="logo__image" src="/temp/logo.png" alt="logo" />
    //         </div>
    ...
    //             <svg alt="logout">
    //               <use xlinkHref="../public/img/icon/sprite.svg#logout"></use>
    //             </svg>
    //           </div>
    //         </div>
    ...
    //                     <use
    //                       xlinkHref="../public/img/icon/sprite.svg#icon-dislike"
    //                     ></use>
    //                   </svg>
    //                 </div>
    //               </div>
    ...
    //                   <use xlinkHref="../public/img/icon/sprite.svg#icon-volume"></use>
    //                 </svg>
    //               </div>
    ...
    // </div>
    <div class="nav__logo logo">
      <img class="logo__image" src="/logo512.png" alt="favicon" />
    </div>
  );
}
